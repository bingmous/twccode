function [b_i] = mainf_Initialize_op_AO_fixbf_old()
load ./data/data_main_Initialize_parameters N K eta_i_u eta_i_d S_ij_UL S_ij_DL S_ij_CS...
    f_c b_ac C_ij_AP C_ij_CC alpha_i beta_i r_j R B_UL B_DL f_AP...
    theta
...
c_i_c = [C_ij_AP - alpha_i(1) * C_ij_CC zeros(N, 1)]'; % (K+1)*N
...
save ./data/data_mainf_Initialize_op_AO_fixbf_old
