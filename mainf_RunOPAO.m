function [data_o_ij_r, data_a_j_r, data_b_i] = mainf_RunOPAO()
% alternative optimization

% -----------start-----------------------
mainf_Initialize();% if the parameters.m is modified, it changes also
[o_ij_r, a_j_r, b_i] = mainf_RunOP12(); % the first solution
...
while flag == 1
    ...
    [o_ij_ro, a_j_ro] = mainf_SDR_op_AO1();
...
% save ./data/data_mainf_RunOPAO data_a_j_r data_o_ij_r data_b_i data_CT_save
