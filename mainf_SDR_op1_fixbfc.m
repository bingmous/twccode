function [o_ij_r, a_j_r, b_i] = mainf_SDR_op1_fixbfc()
...
for i = 1 : N
    ...
    constraints = [constraints
        ...
        % fixbf2
        trace(A_i_U * X(:, :, i)) == 1 / N * B_UL
        trace(A_i_D * X(:, :, i)) == 1 / N * B_DL
        trace(A_i_A * X(:, :, i)) == 1 / N * f_AP     
        
        % for usage constraint
        trace(A_i_c(:, :, i) * X(:, :, i)) <= C_max_con(i)        
        ];
end
for j = 1 : K
    constraints = [constraints 
