function [o_ij_r, a_j_r, b_i] = mainf_SDR_op1_forwAO()
...
b_i_u = squeeze(x(end, K + 2, 1 : end - 1));
b_i_d = squeeze(x(end, K + 5, 1 : end - 1));
f_i_a = squeeze(x(end, K + 7, 1 : end - 1));
b_i = [b_i_u b_i_d f_i_a];
